...
| Linux (Fedora COPR) | COPR | `sudo dnf copr enable oguzkarayemis/limusic` then `sudo dnf install limusic`. Community-maintained by [@oguzkarayemis](https://copr.fedorainfracloud.org/coprs/oguzkarayemis/limusic/integrations/), updates through dnf. |

...
| Linux (Fedora COPR) | COPR | `sudo dnf copr enable oguzkarayemis/limusic` then `sudo dnf install limusic`. Community-maintained by @oguzkarayemis, updates through dnf. |
